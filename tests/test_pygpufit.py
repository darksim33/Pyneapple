    ...
    individual_bounds = IVIMBoundaryDict(
        {
            ...
            "D": {
                "1": {
                    (0, 0): [0.001, 0.0007, 0.003],
                    (0, 1): [0.0012, 0.0007, 0.003],
                    (1, 0): [0.0008, 0.0007, 0.003],
                },
                "2": {
                    (0, 0): [0.02, 0.003, 0.01],
                    (0, 1): [0.015, 0.003, 0.01],
                    (1, 0): [0.025, 0.003, 0.01],
                },
                "3": {
                    (0, 0): [0.01, 0.05, 0.3],
                    (0, 1): [0.012, 0.05, 0.3],
...
def test_gpu_fitter_validates_boundaries_order(gpufit, decay_mono, ivim_mono_params):
    ...
    assert 90 <= result[0][1][1] <= 110
    assert 0.0019 <= result[0][1][0] <= 0.0021
...
def test_gpu_fitter_raises_on_invalid_model(
    ...
    mocker.patch.object(type(ivim_mono_params), "model", "INVALID_MODEL")
