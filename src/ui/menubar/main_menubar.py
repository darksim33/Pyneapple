...
#         parent.file_menu = FileMenu(parent)
#         parent.menuBar().addMenu(parent.file_menu)
#
#         parent.edit_menu = EditMenu(parent)
#         parent.menuBar().addMenu(parent.edit_menu)
#
#         parent.fitting_menu = FittingMenu(parent)
#         parent.menuBar().addMenu(parent.fitting_menu)
#
#         parent.view_menu = ViewMenu(parent)
#         parent.menuBar().addMenu(parent.view_menu)
# ----- File Menu
